    ...
    return (
      <Form onSubmit={e => this.addNewStock(e)}>
        <Form.Group widths='equal'>
          <Form.Field>
            <label>Symbol</label>
            <Input fluid placeholder='Symbol' name='symbol' onChange={e => this.fillingStockForm(e)}/>
          </Form.Field>
          <Form.Field>
            <label>Purchased Price</label>
            <Input fluid placeholder='Price' name='purchasePrice' onChange={e => this.fillingStockForm(e)}/>
          </Form.Field>
          <Form.Field>
            <label>Amount of Shares</label>
            <Input fluid placeholder='Shares' name='shares' onChange={e => this.fillingStockForm(e)}/>
          </Form.Field>
        </Form.Group>
